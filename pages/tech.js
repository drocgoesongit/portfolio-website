...
export default function Tech() {
    const data = [
        ...
        },
        {
            title: 'Flutter',
            id: 3,
            main: '/flutter-icon.svg',
            desc: 'Flutter is an open source software development sdk focused on making applicaitons quickly for multiple devices.',
            tag: 'zen',
            bg: '#ebddff',
            text: '#55209a',
        },
        ...
        },
        {
            title: 'Kotlin',
            id: 5,
            main: '/kotlin-icon.svg',
            desc: 'Official language for android development by Google since 2019',
            tag: 'code',
            bg: '#ffbce0',
            text: '#ff00bf',
        },
