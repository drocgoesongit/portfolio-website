            ...
            <main className="min-h-screen max-w-screen ">
                ...
                <div className="mt-12 flex flex-col space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-12 mx-auto items-center w-full md:w-[80%] lg:w-[75%]">
                    <WorkCard
                        ...
                        link={'/work/gdsc'}
                        description={
                            'App made with flutter and dart for POS sales and billing activities.'
                        }
                    ...
                    <WorkCard
                        title={'Zeyn Ecom'}
                        link={'/work/portfolio'}
                        description={`ZEYN ECOM is a fully fledged ecommerce application built with kotlin and java as a native android project.`}
                        arr={[null, null, null, null, null, null, null, null]}
                        img={'/port.png'}
                    />
                    <WorkCard
                        ...
                        link={'/work/chatbot'}
                        description={
                            'A simple chatting application built with Java and firebase database.'
                        }
                        arr={[
                            null,
                            null,
                    ...
                    <WorkCard
                        ...
                        link={'/work/wordle'}
                        description={
                            'App built with flutter that uses coin api to check on crypto-currencies prices in real time.'
                        }
                        arr={[
                            null,
                            null,
